...
const costLines: CostLine[] = [
  ...
  cl({ name: "Waterproofing", tradeId: "waterproofing", category: "Structure & Envelope", owner: "builder", roomIds: ["basement-unfinished", "basement-finished"], markupModel: "passthrough", markupPct: 20, status: "contracted", contractId: "c-oasis", desc: "Interior drainage system (new side of basement) w/ sump pump, remove retaining wall, waterproof walk-out, delta board, backfill to grade.", history: hist(null, 16410, 16410), directPaid: 19692, directPaidDate: "2026-05-06", directPaidNote: "Fully paid on signing (signed Exhibit A-5)." }),
